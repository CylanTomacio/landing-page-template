    ...
    <section name="pricing" className="w-full text-white my-24">
        ...
        <div className="max-w-[1240px] mx-auto py-12">
            <div className="text-center py-8 text-slate-300">
                ...
                <p className="text-3xl">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos ex voluptates aut? Odio optio quo pariatur aspernatur exercitationem minima ut?</p>
            </div>
            <div className="grid md:grid-cols-2 ">
                <div className="bg-white text-slate-900 m-4 p-8 rounded-xl shadow-xl relative">
                    ...
                    <div className="text-2xl">
                        <p className="flex py-4"><CheckIcon className="w-7 text-green-600 mr-5"/> Lorem ipsum dolor sit.</p>
                        <p className="flex py-4"><CheckIcon className="w-7 text-green-600 mr-5"/> Lorem ipsum dolor sit.</p>
                        <p className="flex py-4"><CheckIcon className="w-7 text-green-600 mr-5"/> Lorem ipsum dolor sit.</p>
                        <p className="flex py-4"><CheckIcon className="w-7 text-green-600 mr-5"/> Lorem ipsum dolor sit.</p>
                        <p className="flex py-4"><CheckIcon className="w-7 text-green-600 mr-5"/> Lorem ipsum dolor sit.</p>
